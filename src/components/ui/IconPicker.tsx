...
const ICON_CATEGORIES: Record<string, string[]> = {
  ...
  Exercise: ['Dumbbell', 'Bike', 'PersonStanding', 'Trophy', 'Activity', 'Heart', 'Zap', 'Running', 'Footprints'],
  Social: ['Users', 'MessageCircle', 'Heart', 'PartyPopper', 'Handshake', 'UserPlus', 'Globe'],
  Wellness: ['Spa', 'Leaf', 'Sun', 'Droplets', 'Wind', 'Smile', 'Brain', 'Stethoscope'],
  ...
  Nature: ['Tree', 'Flower', 'Mountain', 'Waves', 'Sunset', 'Cloud', 'Rainbow', 'Snowflake'],
      ...
      <div className="flex gap-1.5 px-4 pb-2 overflow-x-auto scrollbar-none">
        {['All', ...Object.keys(ICON_CATEGORIES)].map((cat) => (
          <button
            ...
            className={cn(
              'flex-none px-3 py-1 rounded-full text-xs font-semibold transition-colors',
              activeCategory === cat
